...
variable slab_xl equal (${xh}-${xl})*0.3+${xl}
variable slab_xh equal (${xh}-${xl})*0.7+${xl}
variable slab_yl equal (${yh}-${yl})*0.0+${yl}
variable slab_yh equal (${yh}-${yl})*0.1+${yl}
variable slab_zl equal (${zh}-${zl})*0.43+${zl}
variable slab_zh equal (${zh}-${zl})*0.43+${zl}
...
fix		4 addatoms deposit 100 2 500 12345 region slab near 1.0 &
                vz -19.174 -19.174 vy 219.163 219.163
                # vz -10.0 -10.0 vy 30.0 30.0
